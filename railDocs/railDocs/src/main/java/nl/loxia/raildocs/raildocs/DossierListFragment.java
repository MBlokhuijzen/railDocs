...
public class DossierListFragment extends ListFragment implements AbsListView.OnItemClickListener {
    ...
    protected void loadingError() {
        Toast.makeText(getActivity(), "Fout tijdens laden dossiers", Toast.LENGTH_SHORT).show();
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (null != listener) {
            listener.dossierGeselecteerd(posten.get((int) id));
        }
    }

    public interface OnFragmentInteractionListener {
        public void dossierGeselecteerd(String post);
    }
